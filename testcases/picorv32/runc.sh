...
mkdir result 
mkdir ${RESDIR}
${LCCDIR}/lcc -Wo-lccdir=${LCCDIR} -S -target=riscv32 ${SRCDIR}/$1.c -o ${RESDIR}/$1.s
...
${BINUTILSDIR}/as -c -o ${RESDIR}/$1.o ${RESDIR}/$1.s
libs=$(<./src/$1/libs.dep)
objs=$(<./src/$1/objs.dep)
${BINUTILSDIR}/ld -c -h -o ${RESDIR}/$1.bin ${libs} ${RESDIR}/start.o ${RESDIR}/io.o ${RESDIR}/$1.o ${objs}
