...
#ifndef	__SYS_FCNTLCOM_H__
#define	__SYS_FCNTLCOM_H__
...
#define	_FBINARY	0x10000	/* open file for binary data */
...
#define	F_BINARY 	14	/* Set binary mode (for stdin/stdout) */
#endif	/* !defined(_POSIX_SOURCE) */
